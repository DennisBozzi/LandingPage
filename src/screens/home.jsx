...
export default function HomePage() {
  return (
    <div className="bg-logo3 bg-fixed bg-cover teste bg-esmaecer bg-blend-lighten bg-no-repeat bg-center h-[600px] w-full flex flex-col justify-start items-center gap-20">
